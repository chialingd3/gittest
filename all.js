...
//         myLink.innerHTML = "<h1>被點擊了</h1>"
//     }else{
//         myLink.innerHTML = "<h1>沒點到</h1>"
//     }
// let fruits = [
//     {
//         name:"Tom",
...
function init(){
    ...
    elecData.forEach(function(item,index){
...
myFilter = document.querySelector(".filter")
myFilter.addEventListener("click",function(e){ 
    str = ""   
    elecData.forEach(function(item){
...
saveBtn.addEventListener("click",function(e){
    let addElecData={}
    addElecData.name = stationName.value 
    addElecData.charge = stationCharge.value
    // console.log(addElecData)
    elecData.push(addElecData)
    stationName.value =""
...
.then(function (response) {
    ...
    userName.textContent = ary[0].name
